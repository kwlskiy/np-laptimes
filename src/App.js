...
import Racers from './pages/Racers.js';
import About from './pages/About.js';
import LapTimeTable from './pages/LapTimeTable.js';
...
function LapTimes() {
	...
	return (
		<>
			{lapTimes.loading ?
				<Container className="App-header"> <span>Loading Lap Times... </span><Spinner animation={'border'}/></Container>
				:
				<>
					...
					<div className="App-header">
						<Routes>
							<Route path="/" element={<LapTimeTable
								lapTimes={lapTimes}
